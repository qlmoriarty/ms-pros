            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::open(['url' => url('/offer/' . $Profile->OfferID . '/'), 'method' => 'PUT', 'class' => 'form-horizontal', 'files' => true]) !!}
                        ...
                        <div class="form-group{{ $errors->has('NickName') ? ' has-error' : '' }}">
                            {!! Form::label('NickName', 'Ник', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('Contacts') ? ' has-error' : '' }}">
                            {!! Form::label('Contacts', 'Контакт', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('Subscribe') ? ' has-error' : '' }}">
                            {!! Form::label('Subscribe', 'Подписка', ['class' => 'col-md-4 control-label']) !!}
                            <div class="col-md-6">
